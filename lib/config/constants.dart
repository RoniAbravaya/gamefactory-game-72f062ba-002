...
class GameColors {
  ...
  static const Color secondary = Color(0xFF17BEBB);
  static const Color accent = Color(0xFFFFC914);
  static const Color success = Color(0xFF2E282A);
  static const Color warning = Color(0xFF76B041);
